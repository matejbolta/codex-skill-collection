...
```sh
python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo matejbolta/codex-skill-collection --ref main --path skills/apple-inspired-product-ui skills/browser-visual-qa skills/project-governance skills/skill-publisher
```
