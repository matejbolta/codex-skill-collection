...
Record the project's authoritative checks here when they are confirmed.

## Known issues and next work

No additional issue is asserted by this baseline. Preserve existing project
documentation and add only verified current facts.
